...
USING EXACT TABLE NAMES FROM YOUR DATABASE
"""
...
class KeekDataExtractor:
    ...
    def extract_interaction_data(self):
        ...
        FROM 
            public.stream_viewer_202511031802
        WHERE 
            post_id IS NOT NULL
        ...
        print(f"✅ Extracted {len(interaction_df)} interactions from stream_viewer_202511031802")
    ...
    def extract_user_data(self, user_ids=None):
        ...
        INNER JOIN (
            ...
            FROM public.stream_viewer_202511031802 
    ...
    def extract_post_data(self, post_ids=None):
        ...
        """
        print("🎬 Extracting post data from post_202511041248...")
        ...
        print(f"✅ Extracted {len(post_df)} posts from post_202511041248")
        return post_df
    ...
    def extract_complete_dataset(self, sample_size=None):
        ...
        print("="*50)
        print("📊 USING EXACT TABLE NAMES:")
        print("   - stream_viewer_202511031802")
        print("   - users_202511031749") 
        print("   - post_202511041248")
        ...
        try:
            ...
            print(f"   Interactions: {len(interaction_df)} (from stream_viewer_202511031802)")
            print(f"   Users: {len(user_df)} (from users_202511031749)")
            print(f"   Posts: {len(post_df)} (from post_202511041248)")
...
def main():
    ...
    print("🎯 KEek COMPLETE DATA EXTRACTOR (FIXED TABLE NAMES)")
    print("="*50)
